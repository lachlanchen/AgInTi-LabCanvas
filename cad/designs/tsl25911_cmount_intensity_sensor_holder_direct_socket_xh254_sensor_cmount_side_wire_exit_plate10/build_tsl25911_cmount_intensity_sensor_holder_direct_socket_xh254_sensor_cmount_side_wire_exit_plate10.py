#!/usr/bin/env python3
"""Build a direct-socket OpenHI-fit C-mount holder for a TSL25911 light sensor module."""
...
STEM = "tsl25911_cmount_intensity_sensor_holder_direct_socket_xh254_sensor_cmount_side_wire_exit_plate10"
