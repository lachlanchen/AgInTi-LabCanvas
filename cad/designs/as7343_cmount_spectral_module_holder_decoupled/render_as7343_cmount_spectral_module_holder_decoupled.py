#!/usr/bin/env python3
"""Render the decoupled AS7343 C-mount spectral module holder."""
...
def setup_scene() -> None:
    ...
    mats = {
        "cmount": material("matte dark gray independent C-mount tube", (0.47, 0.47, 0.42, 1.0), 0.68),
    ...
    import_stl(CMOUNT_TUBE_STL, "independent OpenHI 24.8 threaded C-mount tube", mats["cmount"])
