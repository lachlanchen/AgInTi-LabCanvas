# AS7343 C-Mount Spectral Module Holder Decoupled

New independent CAD design for holding an AS7343 spectral analysis module behind
an OpenHI-print-fit C-mount receiver. This version is derived from the printed
AS7343 holder but removes the rectangular bridge/cube between the C-mount tube
and the rear sensor plate. The C-mount/tube and the sensor plate are exported
as adjacent independent bodies in the assembly so Shapr3D can select and edit
them separately. Older CAD designs are not modified.
...
- Keep the female thread cutter fully inside the `12 mm` C-mount socket:
  x=`0.2` to
  x=`10.2`.
- Export the C-mount/tube and sensor plate as separate adjacent solids; they
  touch at x=`30.0` without a bridge cube or boolean union.
...
| Output | Path |
| --- | --- |
| multibody_holder_step | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_multibody_holder.step` |
| multibody_holder_stl | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_multibody_holder.stl` |
| cmount_tube_step | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_cmount_tube.step` |
| cmount_tube_stl | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_cmount_tube.stl` |
| sensor_plate_step | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_sensor_plate.step` |
| sensor_plate_stl | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_sensor_plate.stl` |
| assembly_step | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_assembly.step` |
| assembly_stl | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_assembly.stl` |
| thread_cutter_step | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_female_thread_cutter.step` |
| thread_cutter_stl | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_female_thread_cutter.stl` |
| board_proxy_step | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_board_proxy.step` |
| board_proxy_stl | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_board_proxy.stl` |
| rear_alignment_svg | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_rear_alignment.svg` |
| rear_alignment_png | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_rear_alignment.png` |
| rear_alignment_pdf | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_rear_alignment.pdf` |
| render_png | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_render.png` |
| rear_alignment_render_png | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled_rear_alignment_render.png` |
| blend | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/as7343_cmount_spectral_module_holder_decoupled.blend` |
| manifest | `cad/designs/as7343_cmount_spectral_module_holder_decoupled/artifacts/manifest.json` |

## Parameters

| Parameter | Value |
| --- | --- |
| `name` | `as7343_cmount_spectral_module_holder_decoupled` |
| `design_variant` | `decoupled C-mount tube and sensor holder plate; no rectangular bridge block` |
...
```bash
cad/.conda/cad-python/bin/python cad/designs/as7343_cmount_spectral_module_holder_decoupled/build_as7343_cmount_spectral_module_holder_decoupled.py
blender --background --python cad/designs/as7343_cmount_spectral_module_holder_decoupled/render_as7343_cmount_spectral_module_holder_decoupled.py
```
