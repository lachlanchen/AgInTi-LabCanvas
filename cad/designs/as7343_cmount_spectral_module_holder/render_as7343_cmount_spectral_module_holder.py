#!/usr/bin/env python3
"""Render the AS7343 C-mount spectral module holder."""
...
STEM = "as7343_cmount_spectral_module_holder"
...
def setup_scene() -> None:
    ...
    mats = {
        ...
        "board": material("transparent deep blue estimated module board", (0.02, 0.22, 0.70, 0.66), 0.45),
    ...
    import_stl(BOARD_STL, "estimated AS7343 module board proxy, sensor centered", mats["board"])
