# OpenHI Same-Lens 4f System: GLA11-025-025-A plano-convex lens

## Use This

- `USE_THIS_gla11_025_025_openhi_4f_assembly.step`: six mechanical parts plus three lens copies and a beam-splitter reference.
- `artifacts/parts/`: separate STEP, STL, and 3MF files for A, A+C+BS, B, C, Lens B holder, and Lens C holder.
- `artifacts/gla11_025_025_lens.step`: standalone lens model.
...
- modeled mechanical edge thickness: `2.072 mm`;
...
```bash
cad/.conda/cad-python/bin/python cad/designs/openhi_4f_gla11_025_025_same_lens/build_gla11_025_025_openhi_4f.py
blender --background --python cad/tools/render_openhi_same_lens_4f.py -- --design-dir cad/designs/openhi_4f_gla11_025_025_same_lens
```
