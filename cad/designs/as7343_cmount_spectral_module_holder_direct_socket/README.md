# AS7343 C-Mount Spectral Module Holder Direct Socket
...
| Output | Path |
| --- | --- |
| multibody_holder_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_multibody_holder.step` |
| multibody_holder_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_multibody_holder.stl` |
| cmount_socket_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_cmount_socket.step` |
| cmount_socket_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_cmount_socket.stl` |
| sensor_plate_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_sensor_plate.step` |
| sensor_plate_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_sensor_plate.stl` |
| assembly_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_assembly.step` |
| assembly_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_assembly.stl` |
| thread_cutter_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_female_thread_cutter.step` |
| thread_cutter_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_female_thread_cutter.stl` |
| board_proxy_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_board_proxy.step` |
| board_proxy_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_board_proxy.stl` |
| rear_alignment_svg | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_rear_alignment.svg` |
| rear_alignment_png | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_rear_alignment.png` |
| rear_alignment_pdf | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_rear_alignment.pdf` |
| render_png | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_render.png` |
| rear_alignment_render_png | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket_rear_alignment_render.png` |
| blend | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/as7343_cmount_spectral_module_holder_direct_socket.blend` |
| manifest | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket/artifacts/manifest.json` |

## Parameters

| Parameter | Value |
| --- | --- |
| `name` | `as7343_cmount_spectral_module_holder_direct_socket` |
