...
PARAMS = {
    ...
    "anti_warp_ear_style": "four removable 0.5 mm thick Y corner ears per printed part; wider side contacts sit directly against the corner",
    ...
    "anti_warp_ear_note": "Run-4 changes the weak dimension to 0.5 mm Z thickness. The Y arms now touch the corner through wider side contacts, so the tab grips the plate better but can still be peeled/cut away as a thin sacrificial layer.",
...
Z thickness of the sacrificial layer. The side contacts are wider and sit
directly against the corner, then grow into a diagonal Y tail pad outside the
corner so the corner is pulled down during printing.
