...
- `cad/designs/cage_sample_holder_two_piece_lock_slide_petri35/runs/run-4-thin-0p5mm-direct-corner-ears-20260710T123419Z/`
- `cad/designs/cage_sample_holder_two_piece_lock_slide_petri35/runs/run-5-full-corner-diagonal-ears-20260710T130229Z/`
...
four outer corners. In the latest run, the weak dimension is the `0.5 mm`
