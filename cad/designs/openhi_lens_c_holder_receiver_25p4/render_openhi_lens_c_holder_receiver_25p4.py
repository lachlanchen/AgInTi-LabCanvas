#!/usr/bin/env python3
"""Render the OpenHI Lens C holder 25.4 mm receiver variant."""
...
def setup_scene(stl_path: Path, cutaway: bool = False) -> dict:
    ...
    mat_holder = material("warm gray Lens C 25.4 receiver variant", (0.68, 0.67, 0.61, 1.0), 0.64)
    mat_axis = material("gold optical axis", (1.0, 0.72, 0.08, 0.9), 0.28)
    mat_receiver = material("transparent green 25.4 receiver envelope", (0.0, 0.65, 0.28, 0.24), 0.42)
    ...
    holder.name = "OpenHI Lens C holder 25.4 receiver variant"
    ...
    if not cutaway:
        ...
        add_x_cylinder("25.4 mm receiver nominal envelope", 12.7, 8.55, (331.625 - center.x, 0, 0), mat_receiver)
