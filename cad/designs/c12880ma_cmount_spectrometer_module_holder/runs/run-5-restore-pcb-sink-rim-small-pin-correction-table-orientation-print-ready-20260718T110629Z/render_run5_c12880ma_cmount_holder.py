#!/usr/bin/env python3
"""Render the simple C12880MA run-5 mating-orientation holder."""
...
def render_measured_assembly(
    ...
    # Pull the simple measured envelopes outward as one rigid unit. No extra
    # connector or module geometry is introduced in this fit-check render.
