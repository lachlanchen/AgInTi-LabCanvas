#!/usr/bin/env python3
"""Render the print body and measured-module assembly for C12880MA run 1."""
...
def render_measured_assembly(
    ...
    # Pull the module 11 mm rearward as one rigid unit. The package remains
    # partly engaged in the plate opening, while its centered optical face and
    # the offset PCB become visible in a single inspection render.
