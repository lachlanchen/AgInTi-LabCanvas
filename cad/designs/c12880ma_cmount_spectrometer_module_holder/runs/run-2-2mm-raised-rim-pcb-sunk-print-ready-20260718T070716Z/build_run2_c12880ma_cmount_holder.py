#!/usr/bin/env python3
"""Build run 2 with a 2 mm raised rim that recesses the module PCB."""
...
STEM = "c12880ma_cmount_holder_42x42_2mm_pcb_rim_run2"
...
def build_assembly() -> cq.Assembly:
    ...
    assembly.add(
        build_holder_plate(),
        name="independent_42x42_sensor_holder_plate_with_2mm_rear_rim",
...
blender --background --python {repo_path(path.parent / 'render_run2_c12880ma_cmount_holder.py')}
```
