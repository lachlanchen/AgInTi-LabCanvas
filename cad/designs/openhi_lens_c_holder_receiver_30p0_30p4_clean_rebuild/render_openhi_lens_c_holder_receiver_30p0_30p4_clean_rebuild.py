#!/usr/bin/env python3
"""Render the OpenHI Lens C holder clean 30.0/30.4 mm receiver variant."""
...
def render_settings() -> None:
    ...
    bpy.context.scene.view_settings.exposure = 1.85
...
def setup_scene(stl_path: Path, cutaway: bool = False) -> dict:
    ...
    mat_holder = material("warm gray Lens C clean receiver variant", (0.76, 0.75, 0.68, 1.0), 0.64)
    mat_axis = material("gold optical axis", (1.0, 0.72, 0.08, 0.9), 0.28)
    mat_receiver = material("transparent green 30.4 clean receiver envelope", (0.0, 0.65, 0.28, 0.24), 0.42)
    ...
    holder.name = "OpenHI Lens C holder clean 30.0/30.4 receiver variant"
    ...
    if not cutaway:
        ...
        add_x_cylinder("clean 30.4 mm receiver groove envelope", 15.2, 8.65, (331.575 - center.x, 0, 0), mat_receiver)
