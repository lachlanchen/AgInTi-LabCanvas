#!/usr/bin/env python3
"""Render run 1 exact 6 mm vertical 3x3 rod grid."""
...
def fit_camera() -> None:
    bpy.ops.object.light_add(type="AREA", location=(0, -82, 100))
...
def main() -> None:
    clear_scene()
    bpy.context.scene.world.color = (0.9, 0.9, 0.88)
    mat = make_material("satin rod material", (0.72, 0.71, 0.66, 1))
    import_stl(STL, mat)
    fit_camera()
