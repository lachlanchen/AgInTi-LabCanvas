# AS7343 C-Mount Spectral Module Holder LED Clearance 25.4

New independent CAD design for holding an AS7343 spectral analysis module behind
an industrial-size `25.4 mm` C-mount receiver. This version removes both
...
| Output | Path |
| --- | --- |
| multibody_holder_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_multibody_holder.step` |
| multibody_holder_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_multibody_holder.stl` |
| cmount_socket_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_cmount_socket.step` |
| cmount_socket_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_cmount_socket.stl` |
| sensor_plate_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_sensor_plate.step` |
| sensor_plate_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_sensor_plate.stl` |
| assembly_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_assembly.step` |
| assembly_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_assembly.stl` |
| thread_cutter_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_female_thread_cutter.step` |
| thread_cutter_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_female_thread_cutter.stl` |
| board_proxy_step | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_board_proxy.step` |
| board_proxy_stl | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_board_proxy.stl` |
| rear_alignment_svg | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_rear_alignment.svg` |
| rear_alignment_png | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_rear_alignment.png` |
| rear_alignment_pdf | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_rear_alignment.pdf` |
| render_png | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_render.png` |
| rear_alignment_render_png | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4_rear_alignment_render.png` |
| blend | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4.blend` |
| manifest | `cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/artifacts/manifest.json` |

## Parameters

| Parameter | Value |
| --- | --- |
| `name` | `as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4` |
| `design_variant` | `direct C-mount socket to sensor holder plate; five pin-header reserved holes placed on the PCB placeholder; 4 mm AS7343 board-LED clearance channel connected to the optical bore; standard 25.4 mm C-mount female bore/root; half-pitch thread runout cutter for fully developed end threads` |
...
```bash
cad/.conda/cad-python/bin/python cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/build_as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4.py
blender --background --python cad/designs/as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4/render_as7343_cmount_spectral_module_holder_direct_socket_led_clearance_25p4.py
```
