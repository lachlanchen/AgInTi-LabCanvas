...
def setup_scene() -> None:
    ...
    add_box(
        "TSL25911 package centered on optical axis",
        (
    ...
    add_x_cylinder("TSL25911 active aperture marker", params["tsl25911_window_diameter_mm"] / 2.0, 1.4, (total_len + params["board_thickness_mm"] + 0.12, 0, 0), mats["axis"], vertices=48)
