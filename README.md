...
| WeCom API bridge | Official AI Bot WebSocket ingress/egress, per-chat Codex sessions, durable LabCanvas routines, and text/media return without a public callback URL | [setup and architecture](docs/WECOM_API_BRIDGE.md), [sidecar runbook](agentic_tools/wecom_agent/README.md) |
