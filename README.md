...
| WeCom API bridge | Separate official AI Bot WebSocket and authorized `wecom-cli` external-group transports, per-chat Codex sessions, and durable LabCanvas routines | [setup and architecture](docs/WECOM_API_BRIDGE.md), [sidecar runbook](agentic_tools/wecom_agent/README.md) |
