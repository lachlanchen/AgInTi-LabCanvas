...
- `PYTHONPATH=src python -m agenticapp wecom external init --chat AgentTest && PYTHONPATH=src python -m agenticapp wecom external probe --json`: configure and validate the separate official external-group CLI transport.
