...
class WorkspaceAgentTests(unittest.TestCase):
    ...
    def test_shared_model_policy_uses_aginti_with_sol_compatibility_lanes(self):
    ...
    def test_dynamic_policy_uses_aginti_medium_for_tool_work(self):
    ...
    def test_presentation_work_uses_primary_backend_xhigh(self):
        with patch.dict(
            "os.environ",
