...
\t\t(pad "4" smd roundrect (at 2.45 -1.6) (size 1.5 1.0) (layers "F.Cu" "F.Mask" "F.Paste") (roundrect_rratio 0.08) (net 5 "DIN_LED") (pinfunction "DIN") (pintype "input") (uuid "{uid("d1:pad4")}"))
...
\t\t(tags "1x04 2.54mm pin header SK6812RGBW")
...
\t(paper "A4")
\t(lib_symbols)
\t(text "Board-only schematic stub. The PCB has one SK6812RGBW 5050 LED, 330R DIN resistor, 0.1uF local decoupling, and 1x04 5V/GND/DIN/DOUT header." (at 65 76.2 0)
