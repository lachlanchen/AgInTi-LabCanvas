...
\t(segment (start 141.3 98.73) (end 147.55 98.4) (width 0.5) (layer "F.Cu") (net 1) (uuid "{uid("seg:5v-header-led")}"))
\t(segment (start 147.55 98.4) (end 149.2 95.6) (width 0.35) (layer "F.Cu") (net 1) (uuid "{uid("seg:5v-cap")}"))
\t(segment (start 158.7 101.27) (end 152.45 101.6) (width 0.5) (layer "F.Cu") (net 2) (uuid "{uid("seg:gnd-header-led")}"))
...
\t(segment (start 158.7 98.73) (end 152.45 98.4) (width 0.3) (layer "F.Cu") (net 3) (uuid "{uid("seg:din")}"))
\t(segment (start 141.3 101.27) (end 147.55 101.6) (width 0.3) (layer "F.Cu") (net 4) (uuid "{uid("seg:dout")}"))
)"""
...
\t(paper "A4")
\t(lib_symbols)
\t(text "Board-only schematic stub. The PCB has one SK6812RGBW 5050 LED, direct DIN/DOUT routing, 0.1uF local decoupling, and two 1x02 side headers: J1 DOUT/+5V, J2 GND/DIN." (at 65 76.2 0)
